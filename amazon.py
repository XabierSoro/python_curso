...
while validar == False:
    ...
    if contrasena in ("password", "contraseña", "1234567"): #si la palabra código está en el texto, nos imprime la frase siguiente
        ...
        print("La contraseña es muy corta ")# si la contraseña es muy corta
    else:
        validar=True # si pasa los controles validamos con el True y salimos del bucle While

print("Nombre y contraseña guardadas")
nombre= nombre.title()# nos pone en mayúsculas las primeras letras
